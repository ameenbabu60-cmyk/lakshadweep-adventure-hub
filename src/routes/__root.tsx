...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Adventure Peak Travels in Lakshadweep offers curated Lakshadweep holiday packages, flight tickets and tourist visa services for UAE, Malaysia, Maldives & Singapore." },
      { name: "author", content: "Adventure Peak Travels" },
      { name: "theme-color", content: "#0e8a9b" },
      { property: "og:site_name", content: "Adventure Peak Travels" },
